package kg.manasuniversity.usbtypec.manashelper.foodmenu.dailymenu.integration.manas.parser;
...
public class DailyMenuParser {
  ...
  private Optional<DailyMenu> parseDailyFoodMenuHtml(
    ...
    DailyMenu menu = new DailyMenu(null, parsedFoodItems, date.get(), 0.0, 0, false);
